 ...
 */
(function () {
    var EnTable = function (bstableId, url, columns, methodObj) {
        ...
        this.onLoadSuccess = methodObj;  //方法
    };
        ...
        init: function () {
            ...
            this.btInstance =
                $('#' + tableId).bootstrapTable({
                    ...
                    iconSize: 'outline',
                    onLoadSuccess:this.onLoadSuccess,   //加载完成后执行的方法
                    onColumnSwitch:this.onLoadSuccess,  //改变列数后执行的方法
                    onPageChange:this.onLoadSuccess,
                    rowStyle:{
                        /*css:{"height":"10px","font-size":"17px"}*/
                    }
                });
            return this;
        },
