    ...
    private void handle(ProceedingJoinPoint point) throws Exception {
        ...
        if (bussinessName.contains("修改") || bussinessName.contains("编辑")) {
            if("1".equals(type)){
                ...
                List<Map<String,Object>> listStart = LogObjectHolder.me().getListStart(); //修改前值
                List<Map<String,Object>> listEnd = LogObjectHolder.me().getListEnd();  //修改后值
                msg = Contrast.contrastList(listStart,listEnd);
            }
        } else {
