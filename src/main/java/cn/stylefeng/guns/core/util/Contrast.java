...
public class Contrast {
     ...
     * @Date 2017/5/9 19:34
     */
    public static String contrastList(List<Map<String,Object>> listStart,List<Map<String,Object>> listEnd){
        String str;
        str = "新值： "+JSONUtils.toJSONString(listEnd) + "<br/><br/><br/><br/>旧值： " + JSONUtils.toJSONString(listStart);
        return str;
    }
